[![Build Status](https://circleci.com/gh/cloudify-examples/mongodb-blueprint.svg?style=shield&circle-token=:circle-token)](https://circleci.com/gh/cloudify-examples/mongodb-blueprint)
...
[Right-click and copy URL](https://github.com/cloudify-examples/mongodb-blueprint/archive/master.zip). Paste the URL where it says `Enter blueprint url`. Provide a blueprint name, such as `mongodb` in the field labeled `blueprint name`.
